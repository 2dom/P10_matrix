...
This driver only implements 8 colors and only works with ESP8266 microcontrollers. Tt should be rather straightforward to extend it to more colors or Atmel based Arduinos.
