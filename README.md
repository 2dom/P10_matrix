...
This driver only implements 8 colors and currently only works with ESP8266 microcontrollers. However, it should be rather straightforward to extend it to more colors or Atmel based Arduinos.
